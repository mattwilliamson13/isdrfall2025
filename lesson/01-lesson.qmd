...
You should be able to get to our server by clicking [this link](https://rstudio.apps.aws.boisestate.edu/) or the [{{< fa cloud >}}](https://rstudio.apps.aws.boisestate.edu/) in the upper right corner of the webpage. Assuming you've registered for the course, I've given your name and email to our IT admin and they should have sent you a username and password. Once you've clicked that you should see:
![](img/01/login.png)
Enter your username and password (provided by OIT) and click `Sign In`. You should now see the main `Rstudio` environment.
