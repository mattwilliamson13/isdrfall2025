...
- {{< fa envelope >}} &nbsp; <a href=mailto:{{< var instructor.email >}}</a>
...
**NEED TO ADJUST THIS**
- Points for course
- Assignments/exercises complete/not
- Revisions based on Goals from self assessment
- Final Project based on goals from self assessment
- Need to rework
...
::: {.callout-tip}
You can miss up to 3 in-class exercises and still recieve full-credit for this portion of the course.
:::
