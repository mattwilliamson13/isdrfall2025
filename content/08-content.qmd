...
- <i class="fas fa-external-link-square-alt"></i> [Scale and Projections](https://open.lib.umn.edu/mapping/chapter/3-scale-and-projections/) by Matson et al. provides an accessible overview to what projections are and why we need them.
