...
#| echo: false
#| out-width: "70%"
knitr::include_graphics("img/credentialsuccess.png", error = FALSE)
```
...
knitr::include_graphics("img/gittab.png", error = FALSE)
```
...
knitr::include_graphics("img/new_directory.PNG")
```
